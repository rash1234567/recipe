      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        >
          <Image
            ...
            resizeMode="stretch"
            style={{ height: height / 14, width: width / 8 }}
          />
          <View style={{ flex: 1, marginHorizontal: 10 }}>
            ...
            <Text style={[style.r12, { color: theme.disable }]}>
              it's beyond my expectation, it's so delicious
            </Text>
          </View>
        ...
        >
          <Image
            source={require("../../assets/image/d2.png")}
            resizeMode="stretch"
            style={{ height: height / 14, width: width / 8 }}
          />
          <View style={{ flex: 1, marginHorizontal: 10 }}>
            <Text style={[style.r12, { color: Colors.primary }]}>
              ...
              <Text style={{ color: theme.txt }}>
                {" "}
                mentioned you in the comments :
              </Text>
            </Text>
            <Text style={[style.r12, { color: theme.disable }]}>
              you can add more cheese on ...
            </Text>
          </View>
        ...
        >
          <Image
            source={require("../../assets/image/d3.png")}
            resizeMode="stretch"
            style={{ height: height / 14, width: width / 8 }}
          />
          <View style={{ flex: 1, marginHorizontal: 10 }}>
        ...
        >
          <Image
            source={require("../../assets/image/d4.png")}
            resizeMode="stretch"
            style={{ height: height / 14, width: width / 8 }}
          />
          <View style={{ flex: 1, marginHorizontal: 10 }}>
        ...
        >
          <Image
            source={require("../../assets/image/d5.png")}
            resizeMode="stretch"
            style={{ height: height / 14, width: width / 8 }}
          />
          <View style={{ flex: 1, marginHorizontal: 10 }}>
        ...
        >
          <Image
            source={require("../../assets/image/d6.png")}
            resizeMode="stretch"
            style={{ height: height / 14, width: width / 8 }}
          />
          <View style={{ flex: 1, marginHorizontal: 10 }}>
