...
export default function Recipe() {
  ...
  return (
    <SafeAreaView style={[style.area, { backgroundColor: theme.bg }]}>
      ...
      <ImageBackground
        source={require("../../assets/image/s9.png")}
        resizeMode="stretch"
      ...
      <View
        style={{ flex: 1, backgroundColor: theme.bg, paddingHorizontal: 20 }}
      >
        <ScrollView
        ...
        >
          ...
          <Text style={[style.r12, { color: theme.disable, marginTop: 10 }]}>
            Pasta mixed with fresh vegetables and doused with a delicious sauce
            with a high taste, this food is rich in nutrients and is very
            suitable for...{" "}
          ...
          >
            <Text style={[style.r14, { color: theme.txt, flex: 1 }]}>
              Pasta
            </Text>
