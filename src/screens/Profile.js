...
export default function Profile() {
    ...
    return (
        <SafeAreaView style={[style.area, { backgroundColor: theme.bg }]}>
            ...
            <ImageBackground source={require('../../assets/image/s1.png')} resizeMode='stretch' style={{ height: height / 3.5, }} >
                <AppBar
                    elevation={0}
                    ...
                    trailing={<Icon name="share-social" color={Colors.secondary} size={25} />}
                />
            </ImageBackground>

            <View style={{ backgroundColor: theme.bg, flex: 1, marginTop: -50, borderTopLeftRadius: 20, borderTopRightRadius: 20, paddingHorizontal: 20 }}>
                <Avatar.Image source={require('../../assets/image/s2.png')} size={80} style={{ backgroundColor: theme.bg, alignSelf: 'center', marginTop: -40 }} />

                <Text style={[style.s16, { color: theme.txt, marginTop: 10, textAlign: 'center' }]}>Tania Adams</Text>
                <Text style={[style.r12, { color: theme.disable, textAlign: 'center' }]}>@taniaadams</Text>
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <Text style={[style.m16, { color: theme.txt, marginTop: 20 }]}>The Recipe</Text>
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 20 }}>
                        ...
                        <View style={{ marginLeft: 10, flex: 1 }}>
                            ...
                            <Text style={[style.r12, { color: theme.disable, }]}>25 December 2021</Text>
                        </View>
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 20 }}>
                        ...
                        <View style={{ marginLeft: 10, flex: 1 }}>
                            ...
                            <Text style={[style.r12, { color: theme.disable, }]}>10 December 2021</Text>
                        </View>
                        <Icon name="bookmark" color={Colors.primary} size={25} />
                    </View>

                    <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 20 ,marginBottom:20}}>
                        <Image source={require('../../assets/image/s5.png')} style={{ height: height / 9, width: width / 4, resizeMode: 'stretch' }} />
                        <View style={{ marginLeft: 10, flex: 1 }}>
                            <Text style={[style.m16, { color: theme.txt, }]}>Sandwich with egg</Text>
                            <Text style={[style.r12, { color: theme.disable, marginVertical: 7 }]}>20 min    |    1  serve</Text>
                            <Text style={[style.r12, { color: theme.disable, }]}>29 December 2021</Text>
                        </View>
