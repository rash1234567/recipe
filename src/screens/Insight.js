        ...
        <View style={[style.main, { backgroundColor: theme.bg }]}>
          ...
          <ScrollView showsVerticalScrollIndicator={false}>
            ...
            >
              ...
              >
                <Text
                  style={[style.r12, { color: theme.txt, marginRight: 10 }]}
                >
                  Last 7 Days
                </Text>
                <Icon name="chevron-down" color={theme.disable} size={20} />
              </View>
              <Text style={[style.r12, { color: theme.txt }]}>
                23 Jan - 29 Jan 2021
              </Text>
            </View>

            <Text style={[style.m16, { color: theme.txt, marginTop: 30 }]}>
              Account Insights
            </Text>
            ...
            >
              <Text style={[style.r12, { color: theme.txt, flex: 1 }]}>
                Visitor
              </Text>
            ...
            >
              <View>
                ...
                />
                <Text style={[style.m12, { color: theme.txt, marginTop: 8 }]}>
                  Beef Ramen
                </Text>
