          ...
          <View style={{ marginHorizontal: 20 }}>
            ...
            >
              <View style={{ flex: 1 }}>
                ...
                <Text
                  style={[style.r12, { color: theme.disable, marginTop: 5 }]}
                >
                  Including trending recipes, event recommendations curated by
                  our team
                </Text>
              </View>
              <Switch
            ...
            >
              ...
              >
                ...
                <Text
                  style={[style.r12, { color: theme.disable, marginTop: 5 }]}
                >
                  Comment on your recipes, including tags in comments, as well
                  as replies to your comments on other people's recipes
                </Text>
              </TouchableOpacity>
              <Switch
                trackColor={{ false: Colors.disable, true: Colors.primary }}
            ...
            >
              <View style={{ flex: 1 }}>
                ...
                <Text
                  style={[style.r12, { color: theme.disable, marginTop: 5 }]}
                >
                  When someone mentions you, either in comments, replies to
                  comments, or in a recipe post
                </Text>
              </View>
              <Switch
                trackColor={{ false: Colors.disable, true: Colors.primary }}
