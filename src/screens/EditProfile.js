            ...
            <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : null}>
                <View style={[style.main, { backgroundColor: theme.bg, }]}>
                    <AppBar
                        ...
                        trailing={<View style={{ paddingHorizontal: 15, paddingVertical: 5, backgroundColor: '#A7F5B3', borderRadius: 25 }}>
                            <Text style={[style.m12, { color: Colors.secondary }]}>Save</Text>
                        </View>}
                    />

                    <ScrollView showsVerticalScrollIndicator={false}>
                        <Image source={require('../../assets/image/s21.png')} style={{ height: height / 8, width: width / 3.5, resizeMode: 'stretch', alignSelf: 'center', marginTop: 15 }} />
                        <Text style={[style.m16, { color: theme.txt, marginTop: 10 }]}>Name</Text>
                        ...
                        <Text style={[style.m16, { color: theme.txt, marginTop: 10 }]}>User ame</Text>

                        <View style={[style.inputContainer, { borderColor: theme.input, borderWidth: 1, backgroundColor: theme.input, marginTop: 5 }]}>
                            <TextInput placeholder='@lauraharper'
                                selectionColor={Colors.primary}
                                placeholderTextColor={Colors.disable}
                                style={[style.r12, { paddingHorizontal: 10, color: theme.txt, flex: 1 }]}
                            />
