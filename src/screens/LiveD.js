...
export default function LiveD() {
  ...
  return (
    <SafeAreaView style={[style.area, { backgroundColor: theme.bg }]}>
      <ImageBackground
        source={require("../../assets/image/a11.png")}
        resizeMode="stretch"
      ...
      >
        ...
        <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
          ...
          <Image
            source={require("../../assets/image/a12.png")}
            resizeMode="stretch"
            style={{
              height: height / 4.2,
              width: width / 2.5,
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View style={{ flexDirection: "row", alignItems: "center" }}>
            <Image
              ...
              resizeMode="stretch"
              style={{ height: height / 25, width: width / 7 }}
            />
            <Text style={[style.r12, { color: theme.disable, marginLeft: 10 }]}>
              8 participants
            </Text>
          </View>

          <Text style={[style.m16, { color: theme.txt, marginTop: 15 }]}>
            Description
          </Text>

          <Text style={[style.r12, { color: theme.disable, marginTop: 10 }]}>
            In this collaboration event, I as the organizer will present an
            event entitled vegetable salad. If you have an accurate recipe for
            this...{" "}
          ...
          >
            ...
            <TouchableOpacity
              onPress={() => navigation.navigate("UploadR")}
              style={{
                backgroundColor: Colors.primary,
                height: height / 26,
                width: width / 3.4,
          ...
          >
            <Image
              ...
              resizeMode="stretch"
              style={{ height: height / 9.5, width: width / 4 }}
            />
            <View style={{ flex: 1, marginLeft: 10 }}>
              ...
              <View style={{ flexDirection: "row", alignItems: "center" }}>
                <Image
                  source={require("../../assets/image/d7.png")}
                  resizeMode="stretch"
                  style={{ height: height / 28, width: width / 13 }}
                />
                <Text
                  style={[style.m12, { color: Colors.primary, marginLeft: 10 }]}
                >
                  Gabriel
                </Text>
              </View>
          ...
          >
            ...
            <View style={{ flex: 1, marginLeft: 10 }}>
              ...
              <View style={{ flexDirection: "row", alignItems: "center" }}>
                <Image
                  source={require("../../assets/image/d8.png")}
                  resizeMode="stretch"
                  style={{ height: height / 28, width: width / 13 }}
                />
                <Text
