        ...
        <SafeAreaView style={[style.area, { backgroundColor: theme.bg }]}>
            ...
            <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : null}>
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    style={{ flexDirection: 'row', alignItems: 'center', marginVertical: 15, paddingHorizontal: 20 }}>
                        <Avatar.Image source={require('../../assets/image/s16.png')} size={80} style={{ backgroundColor: theme.bg, }} />
                        <View style={{ marginLeft: 10, flex: 1 }}>
                            <Text style={[style.subtitle, { color: theme.txt, }]}>Laura Harper</Text>
                            <Text style={[style.r16, { color: theme.disable, }]}>@lauraharper</Text>
                        </View>
                    ...
                    <View style={{ marginHorizontal: 20 }}>
                        ...
                        style={{ flexDirection: 'row', alignItems: 'center', marginTop: 30, }}>
                            ...
                            <Text style={[style.r16, { color: theme.txt, marginLeft: 15, flex: 1 }]}>Notifications</Text>
                            <Icon name="chevron-forward" color={theme.disable} size={25} />
                        </TouchableOpacity>
                        ...
                        style={{ flexDirection: 'row', alignItems: 'center', marginTop: 30, }}>
                            ...
                            <Text style={[style.r16, { color: theme.txt, marginLeft: 15, flex: 1 }]}>Language</Text>
                            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                            <Text style={[style.r12, { color: theme.disable, marginRight: 10,  }]}>English</Text>
                                <Icon name="chevron-forward" color={theme.disable} size={25} />
                            </View>
                        </TouchableOpacity>
                        ...
                        style={{ flexDirection: 'row', alignItems: 'center', marginTop: 30, }}>
                            ...
                            <Text style={[style.r16, { color: theme.txt, marginLeft: 15, flex: 1 }]}>Theme</Text>
                            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                            <Text style={[style.r12, { color: theme.disable, marginRight: 10,  }]}>light</Text>
                                <Icon name="chevron-forward" color={theme.disable} size={25} />
                            </View>
                        </TouchableOpacity>
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 30, }}>
                            ...
                            <Text style={[style.r16, { color: theme.txt, marginLeft: 15, flex: 1 }]}>Help</Text>
                            <Icon name="chevron-forward" color={theme.disable} size={25} />
                        </View>
                        ...
                        style={{ flexDirection: 'row', alignItems: 'center', marginTop: 30, }}>
                            ...
                            <Text style={[style.r16, { color: '#E23D24', marginLeft: 15, flex: 1 }]}>Log out</Text>
                        </TouchableOpacity>
